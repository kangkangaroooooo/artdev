document.addEventListener('DOMContentLoaded', function () {
	...
	function buildModal() {
		...
		// additional link field after description
		var row4 = document.createElement('div');
		row4.className = 'fd-row';
		var labelLink = document.createElement('label');
		labelLink.textContent = 'Link';
		var inputLink = document.createElement('input');
		inputLink.type = 'url';
		inputLink.name = 'link';
		inputLink.placeholder = 'https://example.com';
		row4.appendChild(labelLink);
		row4.appendChild(inputLink);

		rightCol.appendChild(row2);
		rightCol.appendChild(row3);
		rightCol.appendChild(row4);
